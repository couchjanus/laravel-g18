...
// // Если вы хотите добавить имя+префикс в одну группу, то сделайте их массивом, чтобы удобнее было читать:
...
// Route::get('posts/popular', 'BlogController@method');

// Вместо использования контроллера или замыкания вы можете определить URI и путь к файлу представления:
// Route::view('/about', 'pages.about');
// Вы также можете передать массив переменных, которые будут переданы в представление:
// Route::view('/about', 'pages.about', ['year' => date('Y')]);
// Третий аргумент по умолчанию - это перенаправление 301. Если вы хотите создать временный редирект 307, он будет выглядеть так:
